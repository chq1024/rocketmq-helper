...
public class PushConsumerFactory {
    ...
    public void create(Map<String, FilterExpression> topicWithFilter, String consumerGroup, Integer maxThreadNum, MessageListener listener) throws ClientException {
        ...
        PushConsumer pushConsumer = provider.newPushConsumerBuilder()
                ...
                .setSubscriptionExpressions(topicWithFilter)
