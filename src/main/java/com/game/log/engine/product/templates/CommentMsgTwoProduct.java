 ...
 * @author bk
 */
@ExtRocketMQTemplateConfiguration(value = "commentMqTwoProduct", instanceName = "commentTwoProduct", nameServer = "${rocketmq.name-server}", group = "${mq.product.comment.group}")
public class CommentMsgTwoProduct extends AbstractExtTemplate {
